...
export class OmOrderManagerComponent implements OnInit {
  ...
  allColumns : any = [
    { colHeader: TableConstant.transactionType, colDef: TableConstant.TransactionType, key: TableConstant.TransactionType },
    { colHeader: UniqueConstants.OrderNumber, colDef: Column.OrderNumber, key: Column.OrderNumber },
    { colHeader: UniqueConstants.Priority, colDef: "Priority", key: "Priority" },
    { colHeader: ColumnDef.RequiredDate, colDef: "Required Date", key: "Required Date" },
    { colHeader: ColumnDef.userField1, colDef: TableConstant.UserField1, key: this.UserField1 },
    { colHeader: ColumnDef.userField2, colDef: TableConstant.UserField2, key: this.UserField2 },
    { colHeader: ColumnDef.userField3, colDef: "User Field3", key: this.UserField3 },
    { colHeader: ColumnDef.userField4, colDef: "User Field4", key: this.UserField4 },
    { colHeader: ColumnDef.userField5, colDef: "User Field5", key: this.UserField5 },
    { colHeader: ColumnDef.userField6, colDef: "User Field6", key: this.UserField6 },
    { colHeader: ColumnDef.userField7, colDef: "User Field7", key: this.UserField7 },
    { colHeader: ColumnDef.userField8, colDef: "User Field8", key: this.UserField8 },
    { colHeader: ColumnDef.userField9, colDef: "User Field9", key: this.UserField9 },
    { colHeader: ColumnDef.userField10, colDef: "User Field10", key: this.UserField10 },
    { colHeader: "itemNumber", colDef: Column.ItemNumber, key: this.itemNumber },
    { colHeader: UniqueConstants.Description, colDef: Column.Description, key: Column.Description },
    { colHeader: TableConstant.LineNumber, colDef: "Line Number", key: "Line Number" },
    { colHeader: ColumnDef.TransactionQuantity, colDef: TableConstant.TransactionQuantity, key: TableConstant.TransactionQuantity },
    { colHeader: "allocatedPicks", colDef: "Allocated Picks", key: "Allocated Picks" },
    { colHeader: "allocatedPuts", colDef: "Allocated Puts", key: "Allocated Puts" },
    { colHeader: "availableQuantity", colDef: "Available Quantity", key: "Available Quantity" },
    { colHeader: "stockQuantity", colDef: "Stock Quantity", key: "Stock Quantity" },
    { colHeader: TableConstant.WareHouse, colDef: ColumnDef.Warehouse, key: ColumnDef.Warehouse },
    { colHeader: TableConstant.zone, colDef: ColumnDef.Zone, key: ColumnDef.Zone },
    { colHeader: TableConstant.LineSequence, colDef: "Line Sequence", key: "Line Sequence" },
    { colHeader: ColumnDef.ToteID, colDef: Column.ToteID, key: Column.ToteID },
    { colHeader: "toteNumber", colDef: "Tote Number", key: "Tote Number" },
    { colHeader: ColumnDef.UnitOfMeasure, colDef: FilterColumnName.unitOfMeasure, key: this.UnitOfMeasure },
    { colHeader: TableConstant.BatchPickID, colDef: ColumnDef.BatchPickID, key: ColumnDef.BatchPickID },
    { colHeader: "category", colDef: "Category", key: "Category" },
    { colHeader: "subCategory", colDef: "Sub Category", key: "Sub Category" },
    { colHeader: TableConstant.ImportBy, colDef: "Import By", key: "Import By" },
    { colHeader: TableConstant.ImportDate, colDef: "Import Date", key: "Import Date" },
    { colHeader: "importFilename", colDef: "Import Filename", key: "Import Filename" },
    { colHeader: ColumnDef.ExpirationDate, colDef: TableConstant.ExpirationDate, key: TableConstant.ExpirationDate },
    { colHeader: TableConstant.LotNumber, colDef: Column.LotNumber, key: Column.LotNumber },
    { colHeader: TableConstant.SerialNumber, colDef: ColumnDef.SerialNumber, key: ColumnDef.SerialNumber },
    { colHeader: TableConstant.Notes, colDef: "Notes", key: "Notes" },
    { colHeader: ColumnDef.Revision, colDef: TableConstant.Revision, key: TableConstant.Revision },
    { colHeader: "supplierItemID", colDef: "Supplier Item ID", key: "Supplier Item ID" },
    { colHeader: "id", colDef: "ID", key: "ID" },
    { colHeader: ColumnDef.HostTransactionId, colDef: TableConstant.HostTransactionID, key: TableConstant.HostTransactionID },
    { colHeader: UniqueConstants.emergency, colDef: ColumnDef.Emergency, key: ColumnDef.Emergency },
    { colHeader: TableConstant.Location, colDef: Column.Location, key: Column.Location },
    { colHeader: TableConstant.label, colDef: "Label", key: "Label" },
    { colHeader: Column.cell, colDef: TableConstant.Cell, key: TableConstant.Cell }
  ];
