...
const routes: Routes = [
  ...
  { path: 'EventLog', component: EventLogComponent, canActivate: [AuthGuardGuard] },
  { path: 'Preferences', component: OmPreferencesComponent, canActivate: [AuthGuardGuard] },
  { path: 'OmCreateOrders', component: OmCreateOrdersComponent, canActivate: [AuthGuardGuard] },
  { path: AppNames.OrderManager, component: OmOrderManagerComponent, canActivate: [AuthGuardGuard] },
  { path: 'OrderStatus', component: TransactionComponent, canActivate: [AuthGuardGuard] },
  { path: 'InventoryMaster', component: InventoryMasterComponent, canActivate: [AuthGuardGuard] },
  { path: 'InventoryMap', component: InventoryMapComponent, canActivate: [AuthGuardGuard] },
