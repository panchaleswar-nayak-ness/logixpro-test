...
export class PreferencesMarkoutComponent {
  ...
  constructor(public consolidationAPI: ConsolidationApiService,
    ...
    this.markoutForm = new FormGroup({
      ...
      decrementInvOnCompletion: new FormControl(false),
  ...
  setPreferences(item) {
    ...
    this.markoutForm.controls['decrementInvOnCompletion'].setValue(item.decrementInvOnCompletion);
  ...
  updateMarkoutPreferences() {
    let payload = {
      ...
      decrementInvOnCompletion: this.markoutForm.controls['decrementInvOnCompletion'].value,
