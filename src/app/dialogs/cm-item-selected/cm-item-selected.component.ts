...
export class CmItemSelectedComponent implements OnInit { 
  ...
  userData: any;
  displayedColumns: string[] = ['itemNumber', 'warehouse', TableConstant.completedQuantity, ColumnDef.ToteID, 'serialNumber', ColumnDef.userField1, 'lotNumber', ColumnDef.Actions];
  itemSelectTable: any
  dataSourceList: any
