  ...
  getReprocessData() {
    ...
    this.iInductionManagerApi.RPDetails(payLoad).subscribe((res: any) => {
      if (res?.isExecuted) {
        ...
        this.reprocessInfo.controls.transactionType.setValue(
        ...
        this.reprocessInfo.controls.importFileName.setValue(
          item.importFileName
        );
        ...
        this.reprocessInfo.controls.expirationDate.setValue(
          item.expirationDate
        );
        ...
        this.reprocessInfo.controls.transactionQuantity.setValue(
        ...
        this.reprocessInfo.controls.hostTransID.setValue(
          item.hostTransactionID
        );
