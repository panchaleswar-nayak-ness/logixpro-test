...
export class SrCurrentOrderComponent implements OnInit {
  ...
  coloumnTable = [
    ...
    { defination: zoneType.carousel, label: this.fieldMappings?.carousel || 'Carsl', value: zoneType.carousel, filterProperty:TableConstant.Carousel },
    { defination: Column.Row, label: this.fieldMappings?.row || TableConstant.Row, value: Column.Row, filterProperty:TableConstant.Row },
    { defination: TableConstant.shelf, label: this.fieldMappings?.shelf || TableConstant.shelf, value: TableConstant.shelf, filterProperty:TableConstant.shelf },
    { defination: ColumnDef.Bin, label: this.fieldMappings?.bin || TableConstant.Bin, value: ColumnDef.Bin, filterProperty:TableConstant.Bin },
  ...
  searchColumnOptions: any = [
    ...
    { value: TableConstant.Bin, viewValue: this.fieldMappings?.bin || TableConstant.Bin, sortColumn: '7', key: ColumnDef.Bin },
    { value: 'Carsl', viewValue: this.fieldMappings?.carousel || 'Carsl', sortColumn: '4', key: zoneType.carousel },
    ...
    { value: TableConstant.Row, viewValue: this.fieldMappings?.row || TableConstant.Row, sortColumn: '5', key: Column.Row },
    {
    ...
    { value: TableConstant.shelf, viewValue: this.fieldMappings?.shelf || TableConstant.shelf, sortColumn: '6', key: TableConstant.shelf },
    {
      value: 'Trans Qty',
      viewValue: 'Trans Qty',
      sortColumn: '10',
