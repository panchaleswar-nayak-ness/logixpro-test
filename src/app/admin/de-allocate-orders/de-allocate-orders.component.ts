...
export class DeAllocateOrdersComponent implements OnInit {
  ...
  ELEMENT_DATA_1: any[] =[
    ...
    displayedColumns: string[] = ['deallocate','order_no','item_no',UniqueConstants.Description,UniqueConstants.Priority, ColumnDef.TransactionQuantity,'unitOfMeasure',TableConstant.BatchPickID,'trans_type'];
