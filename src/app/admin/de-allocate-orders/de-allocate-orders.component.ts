...
import {ToasterTitle, ToasterType ,ResponseStrings,Column,DialogConstants,StringConditions,UniqueConstants,Style,TableConstant} from 'src/app/common/constants/strings.constants';
...
export class DeAllocateOrdersComponent implements OnInit {
  ...
  ELEMENT_DATA_1: any[] =[
    ...
    displayedColumns: string[] = ['deallocate','order_no','item_no',UniqueConstants.Description,UniqueConstants.Priority, 'transactionQuantity','unitOfMeasure',TableConstant.BatchPickID,'trans_type'];
