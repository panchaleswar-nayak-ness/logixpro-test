...
@Component({
  selector: 'app-lookup-hot-put-away',
  templateUrl: './lookup-hot-put-away.component.html',
  styleUrls: ['./lookup-hot-put-away.component.scss']
})
export class LookupHotPutAwayComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getHotPutAwayTable();
  }

  getHotPutAwayTable() {
    this.iAdminApiService.getLookupTableData("HotPut").subscribe(res => {
      if (res.isExecuted) {
