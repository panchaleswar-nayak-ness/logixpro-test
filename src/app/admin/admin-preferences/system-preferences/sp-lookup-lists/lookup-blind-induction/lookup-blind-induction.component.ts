...
@Component({
  selector: 'app-lookup-blind-induction',
  templateUrl: './lookup-blind-induction.component.html',
  styleUrls: ['./lookup-blind-induction.component.scss']
})
export class LookupBlindInductionComponent implements OnInit {
