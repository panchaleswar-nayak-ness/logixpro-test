...
export class WrvFrontendComponent implements OnInit {
  ...
  generateHTMLAndAppend() { 
    ...
    defaultProject="${this.FileName.split('-')[1] == 'lbl'|| this.FileName?.toLowerCase()?.indexOf(TableConstant.label)>-1 ? 'BCAEC8B2-9D16-4ACD-94EC-74932157BF82':'072A40E4-6D25-47E5-A71F-C491BC758BC9'}" customData="${this.FileName}" ></ll-webreportviewer>`; 
